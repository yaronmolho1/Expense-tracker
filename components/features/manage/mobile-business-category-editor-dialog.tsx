...
interface MobileBusinessCategoryEditorDialogProps {
  isOpen: boolean;
  onClose: () => void;
  business: Business | null;
}

export function MobileBusinessCategoryEditorDialog({
  isOpen,
  onClose,
  business,
}: MobileBusinessCategoryEditorDialogProps) {
    ...
    <>
      <Dialog open={isOpen} onOpenChange={handleOpenChange}>
        <DialogContent className="w-[90vw] sm:w-[450px]">
          <DialogHeader>
            <DialogTitle className="text-lg sm:text-xl">Set Category</DialogTitle>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            ...
            <div>
              ...
              <div className="text-base font-semibold">{business.display_name}</div>
            </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription asChild>
              <div>
                <p className="mb-2">
                  This will update the category for <strong>{business.display_name}</strong> and all its transactions.
                </p>
                {!business.approved && (
                  <p className="mb-2 text-sm text-amber-600 font-medium">
                    Note: Setting a category will also approve this business.
                  </p>
                )}
